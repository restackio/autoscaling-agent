...
This example is to showcase how Restack Cloud will handle autoscaling to handle operations for your agent. Once the app is deployed you can spawn several agents using the agent POST request on the Restack developer ui and then trigger the `memoryIntensiveOperation` event on each of the agents.
